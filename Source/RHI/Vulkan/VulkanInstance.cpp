	...
	void* UserData)
{
	...
	{
		LOG_ERROR(LogVulkan, "{}: {}", LayerPrefix, Message);
	}
	...
	{
		LOG_WARNING(LogVulkan, "{}: {}", LayerPrefix, Message);
	}
	else
	{
		LOG_INFO(LogVulkan, "{}: {}", LayerPrefix, Message);
	}
