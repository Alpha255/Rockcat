...
{
public:
	D3D11ShaderResourceView(const class D3D11Device& Device, const RHIImageCreateInfo& RHICreateInfo);
};

class D3D11RenderTargetView : public D3DHwResource<ID3D11RenderTargetView>
{
public:
	D3D11RenderTargetView(const class D3D11Device& Device, const RHIImageCreateInfo& RHICreateInfo);
};

class D3D11DepthStencilView : public D3DHwResource<ID3D11DepthStencilView>
{
public:
	D3D11DepthStencilView(const class D3D11Device& Device, const RHIImageCreateInfo& RHICreateInfo);
};
