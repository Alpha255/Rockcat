...
private:
	...
	SceneNode::ObjectID m_RootID = SceneNode::InvalidID;
	SceneNode* m_Root = nullptr;

	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<SceneNode>> m_Objects;

	/// For the sake of serialization without RTTI
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<DirectionalLight>> m_DirectionalLights;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<PointLight>> m_PointLights;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<SpotLight>> m_SpotLights;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<AreaLight>> m_AreaLights;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<ModelInstance>> m_Models;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<Camera>> m_Cameras;
	std::unordered_map<SceneNode::ObjectID, std::shared_ptr<SceneNode>> m_DefaultObjects;
